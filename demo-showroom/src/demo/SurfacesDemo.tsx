...
import { Card, CardBody, CardFooter, CardHeader, Stat, trendDirection } from "../../../source/beta-components/card";
import {
  Menu,
  MenuCheckboxItem,
  MenuGroup,
    ...
    <div className="flex flex-col gap-6 p-6">
      <section className={card}>
        ...
        <p className={cardNote}>
          Arrow keys wrap, letters jump, submenus open with ArrowRight. Last action: {lastAction} ·
          closed by: {lastClose}
        </p>
        <div className="flex flex-wrap items-center gap-3">
          ...
          >
            <MenuItem icon={<EditIcon />} shortcut="⌘E" onSelect={() => setLastAction("Edit")}>
              Edit
            </MenuItem>
            ...
            <MenuSub label="Export">
              <MenuItem onSelect={() => setLastAction("Export CSV")}>CSV</MenuItem>
              <MenuItem onSelect={() => setLastAction("Export PDF")}>PDF</MenuItem>
              <MenuSub label="More formats">
                <MenuItem onSelect={() => setLastAction("Export JSON")}>JSON</MenuItem>
              </MenuSub>
            </MenuSub>
            <MenuSeparator />
          ...
          <Menu trigger={<Button variant="ghost">Aligned to the end</Button>} label="Alignment demo" align="end">
      ...
      <section className={card}>
        ...
        <p className={cardNote}>Dashboard tiles, with a trend that never relies on colour alone.</p>
        <div className="grid gap-3 sm:grid-cols-3">
          ...
          <Card variant="elevated">
            <CardBody>
              <Stat label="Open tickets" value="34" loading={loading} help="Updated a minute ago" />
            </CardBody>
          </Card>
        </div>
        ...
        <div className="mt-3">
          <Card>
            <CardHeader
              ...
              actions={
                <Menu trigger={<Button variant="ghost" size="sm">Options</Button>} label="Card options">
