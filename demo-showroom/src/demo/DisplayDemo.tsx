  ...
  return (
    <section className={card}>
      ...
      <p className={cardNote}>
        Stays in the page: neither interrupting like a dialog nor leaving like a
        toast.
      </p>
...
function Badges() {
  ...
  return (
    <section className={card}>
      ...
      <p className={cardNote}>
        A badge is text; a tag comes off. Counts stop at max and say so aloud.
      </p>
      <div className="flex flex-col gap-3">
...
function Avatars() {
  return (
    <section className={card}>
      ...
      <p className={cardNote}>
        The colour is a hash of the name, so the same person is always the same
        colour.
      </p>
...
function Progresses() {
  ...
  return (
    <section className={card}>
      ...
      <p className={cardNote}>
        A known end. Use the Spinner when there is nothing to measure.
      </p>
      <div className="flex flex-col gap-4">
...
function Accordions() {
  return (
    <section className={card}>
      ...
      <p className={cardNote}>
        Native &lt;details&gt;: Enter and Space work, and Ctrl+F finds text in a
        closed panel.
      </p>
      <div className="flex flex-col gap-4">
        <Accordion
